...
//        1. 변수명은 반드시 영어로 입력
//        2. 변수명애 영문자 및 숫자, 특수문자 ($, _)를 사용 가능
//        3. 변수명에 첫글자는 반드시 영문자이어야 함
//        4. 영어 대소문자를 판별함
//        5. 2개 이상의 단어로 조합된 이름의 경우 첫번째 단어는 모두 영어 소문자로 입력, 두번째 이상의 단어는 첫
//        글자는 영어 대문자, 두번째 글자 이후로는 영어 소문자로 입력
//        6. 자바 예약어는 변수명으로 사용할 수 없음
        ...
        int iphone15max = 180;
        int iphone1$ = 150; // 변수 이름에 특수문자 $, _ 사용 가능
...
//        데이터 초기화 : 변수를 선언 후 최초로 데이터를 저장하는 작업
