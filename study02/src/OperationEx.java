...
//        byte 타입의 변수 2개를 연산하여 int 타입의 변수에 저장
//        자동 타입 변환으로 데이터 저장
...
//        int 타입의 변수에 정수끼리 연산한 값을 저장
        ...
        int intValue5 = 10;
//        연산 시 자동 타입 변환으로 인하여 10 / 4.0 이 10.0 / 4.0 이 되어 double 타입의 결과값이 출력됨
//        double 타입의 결과값을 int 타입의 변수에 저장하려고 하기 때문에 오류가 발생함
//        int intValue6 = 10 / 4.0;
//        int 타입의 데이터 / double 타입의 데이터로 연산하여 int 타입의 데이터를 double 타입으로 자동 타입 변환 후 연산
