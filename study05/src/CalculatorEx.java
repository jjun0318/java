...
//        정적 멤버를 사용하여 Calculator 클래스 타입의 객체가 없음
        ...
        System.out.println("----- 인스턴스 멤버를 사용하여 연산 -----");
...
//        정적 멤버를 객체를 통해서 접근하는 방식은 권장되지 않는 방법
        ...
        cal1.num1 = 10;
        cal1.num2 = 20;
        System.out.println("cal1의두 수의 덧셈은 : " + (cal1.num1 + cal1.num2));
        ...
        cal2.staticNum1 = 100;
        cal2.staticNum2 = 200;
        System.out.println("cal2의 static 두 수의 덧셈은 : " + (cal1.staticNum1 + cal1.staticNum2));
