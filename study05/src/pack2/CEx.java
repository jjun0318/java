...
//        클래스 A의 생성자도 default 접근제한자를 사용하기 때문에 다른 패키지에서 생성자를 접근할 수 없음
//        A a = new A();
...
//        클래스 D는 public 접근제한자를 사용하여 외부에서 사용 가능
        D d = new D();
//        클래스 D의 필드인 field4는 private 접근제한자를 사용하여 외부에서 접근 불가
//        System.out.println(d.field4);
//        클래스 D의 메소드 method4는 private 접근제한자를 사용하여 외부에서 접근 불가
//        d.method4();
