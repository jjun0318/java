public class SmartTVEx {
    public static void main(String[] args) {
        ...
        /*RemoteControl 인터페이스와 Searchable 인터페이스를 모두 상속받은 
        구현 클래스 SmartTV의 객체 생성*/
...
//        부모 타입으로 자식 객체의 멤버를 호출할 수 있음
        ...
        s.search("구글");
        /*다중 상속을 받은 자식 객체를 부모 타입인 인터페이스 변수에 대입 후 사용하면 해당
        인터페이스에서 제공하는 멤버만 사용할 수 있음*/
//        s.turnOn();
...
//        인터페이스의 정적 메소드 호출
        ...
        /*부모인 인터페이스 타입의 변수에 자식 클래스 타입의 객체를 대입하고 
        정적 메소드를 호출 시 오류 발생*/
//        r2.changeBattery();
    }
}
