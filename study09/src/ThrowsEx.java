...
//        }
    ...
    public static void StringPrint() throws NumberFormatException {
            String str = null;
...
//        throws : 예외 떠 넘기기
        /*메소드의 매개변수와 코드 블록 사이에 입력하여 해당 메소드를 호출하는 곳에서
        예외처리를 대신 하도록 예외를 전달함*/
//        떠넘길 예외가 여러개일 경우 , 를 사용하여 여러개의 예외를 나열할 수 있음
//        실제 예외가 발생하는 메소드는 소스코드가 간략해짐
        /*예외가 발생하는 메소드를 호출하는 곳에서 대신 예외처리를 하기 때문에
        한곳에서 예외를 관리할 수 있음*/
