...
//        int 타입의 배열 선언하고 배열 arr1을 대입
        ...
        System.out.println("----- 배열 arr1에 데이터 수정 -----\n");
        arr1[0] = 100;
        arr1[1] = 200;
        arr1[2] = 300;
        for (int i = 0; i < arr1.length; i++) {
        ...
        System.out.println("----- 배열 arr2에 데이터 수정 -----\n");
        arr2[0] = 1000;
        arr2[1] = 2000;
        arr2[2] = 3000;
        for (int i = 0; i < arr1.length; i++) {
...
//        원본 배열인 arr3의 데이터가 수정되어도 사본 배열인 arr4의 데이터는 그대로 유지
        ...
        System.out.println("----- arraycopy() 를 사용하여 배열 복사 -----\n");
...
//        5개의 배개변수를 사용함
//        첫번째 매개변수로 원본 배열을 지정, 두번째 매개변수로 원본 배열에서 복사 시작 index, 세번째 매개변수로 사본 배열을 지정, 
//        네번째 매개변수로 복사를 받을 index를 지정, 다섯번째 매개변수로 복사할 크기를 지정
...
//        사용법 : int[] 배열명 = Arrays.copyOfRange(원본배열, 복사 시작 index, 복사완료 index);
